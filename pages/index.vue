...
<template>
  <div>
    <ULandingHero v-if="page.hero" v-bind="page.hero">
      ...
      <img :src="Cell" alt="Cell" class="w-1/2 mx-auto" />
    ...
    <ULandingSection :title="page.features.title" :links="page.features.links">
      ...
      <div class="flex gap-20 flex-col">
        <div class="flex gap-5 flex-col">
          ...
          <p>目前 Cell 生态包含了 Cell Cli 和 Cell Framework，其中，Cell Cli 已支持如下框架和工具，可以享受 Cell 带来的开发和部署的便利。</p>
        ...
        <div class="flex gap-5 flex-col">
          ...
          <p>截至 2024 年 1 月，Cell 经历了五年的打磨和真实项目实践，陆续发布了 321 个版本。目前 Cell 核心部分已经稳定，拥有 10 位左右的核心共建成员。在微信小程序、钉钉小程序、uni-app、门户网站、内容管理平台、云文档平台等场景都有真实项目成功落地。我们自己每天都在用 Cell 开发真实业务项目。</p>
        ...
        <div class="flex gap-5 flex-col">
          ...
          <img src="https://contrib.rocks/image?repo=cellbang/cell" alt="贡献者" />
        </div>
        <div class="flex gap-5 flex-col">
          <h1 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-3xl lg:text-4xl">加入我们</h1>
          <p>Cell 是 MIT 许可的开源项目。需要优秀人士的支持使它不断发展。如果您想加入我们，请联系我们的邮箱kevin@cellbang.com。</p>
