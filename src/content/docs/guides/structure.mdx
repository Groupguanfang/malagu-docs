...
import { LinkCard, CardGrid, FileTree } from "@astrojs/starlight/components";
...
<CardGrid>
  <LinkCard
    ...
    href="/guides/component/#%E7%BB%84%E4%BB%B6%E8%AE%BE%E8%AE%A1"
  />
  <LinkCard title="模块" description="关于详细的约定目录和组件属性配置，参阅详细的组件模块文档。" href="/guides/module" />
</CardGrid>
