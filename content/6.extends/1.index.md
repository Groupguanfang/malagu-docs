...
description: 本篇从零开始创建一个基于 Malagu 框架的 Vue 项目，以便大家更好的了解 Malagu 框架。
---

> Malagu 自带的 cli 工具可快速创建模板项目，可参考以下链接：[创建项目](https://www.yuque.com/cellbang/malagu/ogreg3)、[Vue 开发](https://www.yuque.com/cellbang/malagu/vgim9q)
