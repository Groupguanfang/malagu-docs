...
description: Malagu 框架提供了一系列开箱即用的模板，在模板中，默认提供了基于 GitHub Actions 实现 CI/CD 脚本，我们只需要在平台中注入相应的秘钥即可使用。
---
...
Malagu 框架提供了一系列开箱即用的模板，在模板中，默认提供了基于 GitHub Actions 实现 CI/CD 脚本，我们只需要在平台中注入相应的秘钥即可使用。脚本如下：
...
GitHub 平台会将秘钥，通过环境变量注入到 CI/CD 运行环境中，在 Malagu 框架中，我们可以通过属性配置文件引用当前环境中的环境变量，如下所示：
