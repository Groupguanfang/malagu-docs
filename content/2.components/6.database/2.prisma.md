...
title: Prisma
icon: i-ph-database
description: Malagu 提供了 Prisma 数据库访问框架的支持。
---
...
关于 Webpack Hook，请查看:[Webpack 插件](/main/cli/hook/#webpack-%E6%8F%92%E4%BB%B6)

```typescript [src/hooks/webpack.ts]
...
因为 Prisma 生成的 client 体积非常大，使用直接上传代码包的方式上传的话，可能会超出接口限制，建议使用 malagu 的`通过COS方式部署`能力进行部署。
